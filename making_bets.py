...
def inside_bets() -> dict[int, str]:
    ...
    result = list(zip(chosen_numbers_ints, values))
    return result

def outside_bets() -> tuple[str, str, str, int, int]:
    ...
    for allowed_values in constants:
        x = 1
        while x:
            print("Values allowed for this bet: ", allowed_values)
    ...
    return bet_colour, bet_high_low, bet_dozen, bet_column